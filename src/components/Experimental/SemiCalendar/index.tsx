...
const events = [
    {
        ...
        children: <div style={dailyStyle as any}>TEST June 25th 14:45 ~ July 26th 6:18</div>
    },
    {
        key: '1',
        start: new Date(2019, 6, 18, 10, 0, 0),
        end: new Date(2019, 6, 30, 8, 0, 0),
        children: <div style={allDayStyle as any}>July 18th 10:00 ~ July 30th 8:00</div>
    },
    {
        key: '2',
        start: new Date(2019, 6, 19, 20, 0, 0),
        end: new Date(2019, 6, 23, 14, 0, 0),
        children: <div style={allDayStyle as any}>July 19th 20:00 ~ July 23rd 14:00</div>
    },
    {
        key: '3',
        start: new Date(2019, 6, 21, 6, 0, 0),
        end: new Date(2019, 6, 25, 6, 0, 0),
        children: <div style={allDayStyle as any}>July 21st 6:00 ~ July 25th 6:00</div>
    },
    {
        key: '4',
        allDay: true,
        start: new Date(2019, 6, 22, 8, 0, 0),
        children: <div style={allDayStyle as any}>July 22 full day</div>
    },
    {
        key: '5',
        start: new Date(2019, 6, 22, 9, 0, 0),
        end: new Date(2019, 6, 23, 23, 0, 0),
        children: <div style={allDayStyle as any}>July 22nd 9:00 ~ July 23rd 23:00</div>
    },
    {
        key: '6',
        start: new Date(2019, 6, 23, 8, 32, 0),
        children: <div style={dailyStyle as any}>TEST July 23 8:32</div>
    },
    {
        key: '7',
        start: new Date(2019, 6, 23, 14, 30, 0),
        end: new Date(2019, 6, 23, 20, 0, 0),
        children: <div style={dailyStyle as any}>July 23 14:30-20:00</div>
    },
    {
        key: '7.5',
        start: new Date(2019, 6, 23, 14, 30, 0),
        end: new Date(2019, 6, 23, 20, 0, 0),
        children: <div style={dailyStyle as any}>DJuly 23 14:30-20:00</div>
    },
    {
        key: '8',
        start: new Date(2019, 6, 25, 8, 0, 0),
        end: new Date(2019, 6, 27, 6, 0, 0),
        children: <div style={allDayStyle as any}>July 25th 8:00 ~ July 27th 6:00</div>
    },
    {
        key: '9',
        start: new Date(2019, 6, 26, 10, 0, 0),
        end: new Date(2019, 6, 27, 16, 0, 0),
        children: <div style={allDayStyle as any}>July 26th 10:00 ~ July 27th 16:00</div>
    },
    {
        key: '10',
...
export default function SemiCalendar() {
    return (
        <>
