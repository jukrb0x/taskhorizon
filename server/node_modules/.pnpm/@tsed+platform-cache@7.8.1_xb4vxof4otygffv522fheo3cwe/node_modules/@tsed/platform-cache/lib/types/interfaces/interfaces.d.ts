 ...
 */
export declare type PlatformCacheLegacyStoreFactory = {
    create(...args: any[]): Promise<Store | any> | Store | any;
};
export declare type PlatformCacheSettings<Config extends object = any, S extends Store = any> = CachingConfig<Config> & {
    caches?: Cache[];
