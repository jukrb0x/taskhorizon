...
const setLoggerConfiguration_1 = require("../utils/setLoggerConfiguration");
...
class DITest {
    ...
    static set(key, value) {
        (0, core_1.setValue)(DITest.options, key, value);
    }
    static hasInjector() {
        return !!DITest._injector;
    }
    ...
    static async createContainer() {
        await DITest.injector.load((0, createContainer_1.createContainer)());
    }
    /**
    ...
    static createInjector(settings = {}) {
        ...
        (0, setLoggerConfiguration_1.setLoggerConfiguration)(injector);
        return injector;
    }
    /**
