...
export declare type PlatformParamsScope<Context extends DIContext = DIContext> = {
    $ctx: Context;
} & Record<string, any>;
export declare type PlatformParamsCallback<Context extends DIContext = DIContext> = (scope: PlatformParamsScope) => Promise<any>;
/**
