...
class PlatformContext extends di_1.DIContext {
    ...
    constructor(options) {
        ...
        this.response = new (options.ResponseKlass || PlatformResponse_1.PlatformResponse)(this);
        this.request = new (options.RequestKlass || PlatformRequest_1.PlatformRequest)(this);
