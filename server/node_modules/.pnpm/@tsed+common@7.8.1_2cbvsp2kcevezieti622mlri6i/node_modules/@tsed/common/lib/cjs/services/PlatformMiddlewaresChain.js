...
let PlatformMiddlewaresChain = class PlatformMiddlewaresChain {
    ...
    get(allMiddlewares, operationRoute) {
        ...
        return [ACCEPT_MIMES && PlatformAcceptMimesMiddleware_1.PlatformAcceptMimesMiddleware, FILE && PlatformMulterMiddleware_1.PlatformMulterMiddleware, ...allMiddlewares].filter(Boolean);
    }
