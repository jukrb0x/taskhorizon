...
const contains = (val, obj, start) => {
    if (val == null || obj == null || !(0, core_1.isNumber)(val.length)) {
        return false;
    }
...
exports.helpers.and = (...args) => {
    ...
    return handlebars_utils_1.default.value(val, this, options);
};
/**
 ...
 * @api public
 */
exports.helpers.compare = function (a, operator, b, options) {
    /*eslint eqeqeq: 0*/
    ...
    return handlebars_utils_1.default.value(result, this, options);
};
/**
 ...
 * @api public
 */
exports.helpers.contains = function (collection, value, startIndex, options) {
 ...
 * @api public
 */
exports.helpers.eq = function (a, b, options) {
    if (arguments.length === 2) {
        options = b;
        b = options.hash.compare;
    }
    return handlebars_utils_1.default.value(a === b, this, options);
};
/**
 ...
 * @api public
 */
exports.helpers.gt = function (a, b, options) {
    if (arguments.length === 2) {
        options = b;
        b = options.hash.compare;
    }
 ...
 * @api public
 */
exports.helpers.gte = function (a, b, options) {
    if (arguments.length === 2) {
        options = b;
        b = options.hash.compare;
    }
 ...
 * @api public
 */
exports.helpers.is = function (a, b, options) {
    if (arguments.length === 2) {
        options = b;
        b = options.hash.compare;
    }
 ...
 * @api public
 */
exports.helpers.isnt = function (a, b, options) {
    if (arguments.length === 2) {
        options = b;
        b = options.hash.compare;
    }
 ...
 * @api public
 */
exports.helpers.lt = function (a, b, options) {
    if (arguments.length === 2) {
        options = b;
        b = options.hash.compare;
    }
 ...
 * @api public
 */
exports.helpers.lte = function (a, b, options) {
    if (arguments.length === 2) {
        options = b;
        b = options.hash.compare;
    }
 ...
 * @api public
 */
exports.helpers.neither = function (a, b, options) {
    return handlebars_utils_1.default.value(!a && !b, this, options);
};
/**
 ...
 * @api public
 */
exports.helpers.not = function (val, options) {
    return handlebars_utils_1.default.value(!val, this, options);
};
/**
 ...
 * @api public
 */
exports.helpers.or = function (...args) {
    const len = args.length - 1;
    const options = args[len];
    let val = false;
    for (let i = 0; i < len; i++) {
 ...
 * @api public
 */
exports.helpers.unlessEq = function (a, b, options) {
    if (handlebars_utils_1.default.isOptions(b)) {
        options = b;
        b = options.hash.compare;
    }
    return handlebars_utils_1.default.value(a !== b, this, options);
 ...
 * @api public
 */
exports.helpers.unlessGt = function (a, b, options) {
    if (handlebars_utils_1.default.isOptions(b)) {
        options = b;
        b = options.hash.compare;
    }
 ...
 * @api public
 */
exports.helpers.unlessLt = function (a, b, options) {
    if (handlebars_utils_1.default.isOptions(b)) {
        options = b;
        b = options.hash.compare;
    }
 ...
 * @api public
 */
exports.helpers.unlessGteq = function (a, b, options) {
    if (handlebars_utils_1.default.isOptions(b)) {
        options = b;
        b = options.hash.compare;
    }
 ...
 * @api public
 */
exports.helpers.unlessLteq = function (a, b, options) {
    if (handlebars_utils_1.default.isOptions(b)) {
        options = b;
        b = options.hash.compare;
    }
