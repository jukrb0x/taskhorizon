export declare type RenderCallback = (err: Error | null, str?: string | any) => any;
...
export declare function getEngine(name: string): EngineFunction;
export declare function getEngines(): Record<string, EngineFunction>;
